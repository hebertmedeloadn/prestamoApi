...
public class ServicioCrearPrestamoTest {
	...
	@Mock
	private RespositorioPrestamo repositorioPrestamo;
	...
	public void validarRegistro() {
		...
		CalcularIntereses prestamoIntereses = new CalcularInteresTestDataBuilder().conValorPrestamo(prestamo.getValor()).build();
		CalcularFechaFinal calcularFechaFinal = new CalcularFechaTestDataBuilder().conFechaInicial(prestamo.getFechaInicial()).build();

		Prestamo prestamoMock = Mockito.mock(Prestamo.class);
		daoPrestamo = Mockito.mock(DaoPrestamo.class);
		...
		repositorioPrestamo = Mockito.mock(RespositorioPrestamo.class);
		...
		// Act
		Long idPrestamoGenerado = servicioCrearPrestamo.ejecutar(prestamo, prestamoIntereses, calcularFechaFinal);
